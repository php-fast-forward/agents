---
name: package-readme
description: Generate or refresh README.md files for Fast Forward PHP packages. Use when an agent needs to create a new package README, reorganize an existing README, improve onboarding and discoverability, or align README structure with the Fast Forward ecosystem.
---
...
- Read `composer.json` early so the package name is available for README copy, Composer commands, Packagist links, and badges
...
- Plan the badge block using [references/badges.md](references/badges.md)
- Prefer the current Fast Forward badge stack over older, thinner README patterns
...
- Validate badge links, section order, and formatting against the current Fast Forward package pattern
...
2. Badges (PHP version, Composer Package/Packagist, tests, coverage, docs, license, sponsors, and relevant standards)
...
- Badges and links are valid and align with the current Fast Forward package pattern
...
| Need | Reference |
|------|-----------|
| Badge patterns and order | [references/badges.md](references/badges.md) |
| Real README examples from the ecosystem | [references/examples.md](references/examples.md) |
| When and how to update README during code changes | [references/update-triggers.md](references/update-triggers.md) |
...
- Do not skip README updates when public APIs change
